...
# external_url 'http://labus.grid.by'
...
ci_external_url 'http://labus.grid.by'
...
#gitlab_ci['gitlab_server'] = { "url" => 'http://git.labus.grid.by', "app_id" => '12345678', "app_secret" => 'QWERTY12345' }

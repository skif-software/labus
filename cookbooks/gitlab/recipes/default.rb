...
############# tmp fix ############
#
#patched_recipes = ["database_migrations.rb", "gitlab-ci.rb"]
#patched_recipes.each do |recipe|
#  cookbook_file "/opt/gitlab/embedded/cookbooks/gitlab/recipes/#{recipe}" do
#    source "#{recipe}"
#    mode 0644
#    owner "root"
#    group "root"
...
#end
#
#patched_templates = ["nginx.conf.erb", "secret_token.erb"]
#patched_templates.each do |template|
#  cookbook_file "/opt/gitlab/embedded/cookbooks/gitlab/templates/default/#{template}" do
#    source "#{template}"
#    mode 0644
#    owner "root"
#    group "root"
...
#end
#
#cookbook_file "/opt/gitlab/embedded/cookbooks/gitlab/attributes/default.rb" do
#  source "default-attributes.rb"
#  mode 0644
#  owner "root"
#  group "root"
#end

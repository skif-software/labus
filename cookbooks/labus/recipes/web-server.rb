...
webserver_username = node['labus']['web-server']['username']
webserver_group = node['labus']['web-server']['group']
...
user webserver_username do
  shell node['labus']['web-server']['shell']
  home node['labus']['web-server']['home']
  uid node['labus']['web-server']['uid']
  gid webserver_group
  system true

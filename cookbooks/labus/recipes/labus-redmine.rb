...
# This file is a modified version of gitlab-ci.rb recipe file from omnibus-gitlab

labus_redmine_source_dir = "/opt/gitlab/embedded/service/labus-redmine"
labus_redmine_dir = node['labus']['labus-redmine']['dir']
labus_redmine_home_dir = File.join(labus_redmine_dir, "home")
labus_redmine_etc_dir = File.join(labus_redmine_dir, "etc")
labus_redmine_static_etc_dir = "/opt/gitlab/etc/labus-redmine"
labus_redmine_working_dir = File.join(labus_redmine_dir, "working")
labus_redmine_tmp_dir = File.join(labus_redmine_dir, "tmp")
labus_redmine_tmp_pdf_dir = File.join(labus_redmine_dir, "tmp/pdf")
labus_redmine_log_dir = node['labus']['labus-redmine']['log_directory']
labus_redmine_files_dir = File.join(labus_redmine_dir, "files")
labus_redmine_plugin_assets_dir = File.join(labus_redmine_dir, "plugin_assets")
